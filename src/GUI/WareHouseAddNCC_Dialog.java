...
public class WareHouseAddNCC_Dialog extends javax.swing.JDialog {
                ...
                if (txtNhaCungCap.getText().equals("")) {
                    ...
                    try {
                        ...
                        if (nameFrame == "more_gui"){
                            ...
                            try {
                                gui = new More_GUI();
                                if(sub.getByNameAuthor(p.getSupplier_name())!=null)
                                {
    ...
    protected MyDesign.MyTextField_Basic txtNhaCungCap;
    private SupplyCardBUS scb = new SupplyCardBUS();
    private SupplierBUS sub = new SupplierBUS();
    protected WareHouseImport_Dialog whid = new WareHouseImport_Dialog(null, rootPaneCheckingEnabled);
